...
TICKERS = [
    "TEHOL.IS", "CASA.IS", "AKSUE.IS", "KAREL.IS", "HATSN.IS", "SNICA.IS", "KRDMA.IS", "ALTNY.IS", "CIMSA.IS", "INTET.IS", "YIGIT.IS", "MIATK.IS", "PETKM.IS",

    "AEFES.IS", "AGHOL.IS", "AKSA.IS", "AKSEN.IS", "ALARK.IS", "ALKIM.IS", "ANELE.IS", "ARCLK.IS", "ARDYZ.IS", "ASELS.IS", "ASTOR.IS",
    "AYGAZ.IS", "BAGFS.IS", "BANVT.IS", "BASGZ.IS", "BAYRK.IS", "BERA.IS", "BIMAS.IS", "BINHO.IS", "BIOEN.IS", "BLCYT.IS",
    "BMSCH.IS", "BNTAS.IS", "BORSK.IS", "BRISA.IS", "BRLSM.IS", "BSOKE.IS", "BTCIM.IS", "BUCIM.IS", "CANTE.IS", "CCOLA.IS",
    "CEMAS.IS", "CEMTS.IS", "CIMSA.IS", "CLEBI.IS", "CWENE.IS", "DARDL.IS", "DCTTR.IS", "DEVA.IS", "DOAS.IS", "DOHOL.IS",
    "DYOBY.IS", "ECILC.IS", "EGEEN.IS", "EGGUB.IS", "EKGYO.IS", "ENKAI.IS", "ENJSA.IS", "EREGL.IS", "ESEN.IS", "EUPWR.IS",
    "FROTO.IS", "GESAN.IS", "GWIND.IS", "HEKTS.IS", "INDES.IS", "ISDMR.IS", "IZENR.IS", "JANTS.IS", "KARSN.IS", "KCAER.IS",
    "KCHOL.IS", "KONTR.IS", "KONYA.IS", "KOZAA.IS", "KOZAL.IS", "KRDMA.IS", "KRDMB.IS", "KRDMD.IS", "KRVGD.IS", "KTLEV.IS",
    "KUYAS.IS", "LOGO.IS", "MAGEN.IS", "MAVI.IS", "MEPET.IS", "MGROS.IS", "NETAS.IS", "ODAS.IS", "OTKAR.IS", "OYAKC.IS",
    "PARSN.IS", "PENTA.IS", "QUAGR.IS", "REEDR.IS", "SAHOL.IS", "SASA.IS", "SELEC.IS", "SISE.IS", "SOKM.IS", "TATEN.IS",
    "TAVHL.IS", "TCELL.IS", "TKFEN.IS", "TMSN.IS", "TRCAS.IS", "TRGYO.IS", "TTRAK.IS", "TUKAS.IS", "TUPRS.IS", "VESBE.IS",
    "VESTL.IS", "YEOTK.IS", "ZOREN.IS"
]
